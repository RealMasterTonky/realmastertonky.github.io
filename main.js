let topbarbuttons = {
    "home": `https://realmastertonky.github.io/`,
    "my posts": `https://realmastertonky.github.io/posts`,
    "my artworks": `https://realmastertonky.github.io/artworks`,
    "python programs": `https://realmastertonky.github.io/python`,
...
let posts = [
	...
	["MASTERTONKY IN DESMOS GRAPHING CALCULATOR", [
		...
		`<br>`,
		`<p>now, i assume u wanna do funi things with it too so here's the link to the graph --> <a href="https://www.desmos.com/calculator/tend1mn0cn">click me</a></p>`,
		]
	],
...
let pages = {
    "https://realmastertonky.github.io/": function() {
    ...
    "https://realmastertonky.github.io/posts": function() {
    ...
    "https://realmastertonky.github.io/python": function() {
    ...
    "https://realmastertonky.github.io/roblox": function() {
	...
	"https://realmastertonky.github.io/dreamarchive": function() {
		...
		let dreams = [
			["test", `<p>${rainbowtext("this a test, not a dream! oh btw check this near-unreadable rainbow text i made for a reason i completely fogror")}</p>`, "201?"],
		]
    ...
    "https://realmastertonky.github.io/artworks": function() {
        ...
        document.body.innerHTML += `<button style="font-size:30px" onclick="window.location.href='https://realmastertonky.github.io/artworks/digital'">digital drawings</button><br>pixels arranged in a way that makes (imo) decent images<br><br>`
        document.body.innerHTML += `<button style="font-size:30px" onclick="window.location.href='https://realmastertonky.github.io/artworks/irl'">irl drawings</button><br>pictues of mmmm pencil scribbles with magik colored markers`
    },
    "https://realmastertonky.github.io/artworks/atrocities": function() {
    ...
    "https://realmastertonky.github.io/artworks/digital": function() {
    ...
    "https://realmastertonky.github.io/artworks/irl": function() {
